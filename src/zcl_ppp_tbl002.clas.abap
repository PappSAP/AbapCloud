CLASS zcl_ppp_tbl002 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_ppp_tbl002 IMPLEMENTATION.

METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'PPP',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap_ppp_tbl002.

    "insert travel demo data
    INSERT zrap_ppp_tbl002  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZRAP_PPP_TBL002{ group_id }. | ).
  ENDMETHOD.
